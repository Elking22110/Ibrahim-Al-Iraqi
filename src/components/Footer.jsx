...
const Footer = ({ t, lang }) => {
    return (
        <footer className={`bg-[#111] text-[#f5f5f0] py-20 border-t border-white/10 ${lang === 'ar' ? 'font-cairo' : ''}`}>
            <div className="container mx-auto px-8 md:px-20 grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-sm text-gray-400">
                        <li><a href="#" className="hover:text-[#f5f5f0] transition-colors">Collection</a></li>
                        <li><a href="#" className="hover:text-[#f5f5f0] transition-colors">Bespoke</a></li>
                        <li><a href="#" className="hover:text-[#f5f5f0] transition-colors">Our Story</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div className="flex border-b border-white/20 pb-2">
                        <input type="email" placeholder={t?.emailPlaceholder || "Email Address"} className="bg-transparent w-full outline-none text-[#f5f5f0] text-sm placeholder-gray-600" />
            ...
            <div className="container mx-auto px-8 md:px-20 mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-xs text-gray-600">
                ...
                <div className="flex space-x-6 mt-4 md:mt-0">
                    <a href="https://www.facebook.com/share/17y9z8kF57/" className="hover:text-[#f5f5f0] transition-colors">Facebook</a>
                    <a href="https://www.instagram.com/ibrahimal3raqi?igsh=em45emlzcmVyZnFs" className="hover:text-[#f5f5f0] transition-colors">Instagram</a>
                    <a href="https://wa.me/201009970416" className="hover:text-[#f5f5f0] transition-colors">WhatsApp</a>
                </div>
            </div>
        </footer>
    );
