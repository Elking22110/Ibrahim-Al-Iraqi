    ...
    return (
        <footer className={`bg-[#111] text-white py-20 border-t border-white/10 ${lang === 'ar' ? 'font-cairo' : ''}`}>
            <div className="container mx-auto px-8 md:px-20 grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                {/* Links */}
                <div>
                    <h4 className="text-xs font-bold uppercase tracking-widest mb-6 text-[#C5A880]">{t?.explore || "Explore"}</h4>
                ...
                {/* Visit Us */}
                <div>
                    <h4 className="text-xs font-bold uppercase tracking-widest mb-6 text-[#C5A880]">{t?.visit || "Visit Us"}</h4>
                    <div className="text-sm text-gray-400 space-y-4">
                        ...
                        <a href="tel:+201009970416" dir="ltr" className="flex items-center gap-3 group/phone hover:text-[#C5A880] transition-all duration-300 w-fit">
                            <span className="p-2 rounded-full bg-white/5 group-hover/phone:bg-[#C5A880]/20 transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                                </svg>
                            </span>
                            <span className="border-b border-transparent group-hover/phone:border-[#C5A880] text-lg">+20 100 997 0416</span>
                        </a>
                ...
                {/* Newsletter */}
                <div>
                    <h4 className="text-xs font-bold uppercase tracking-widest mb-6 text-[#C5A880]">{t?.newsletter || "Newsletter"}</h4>
                    ...
                    <div className="flex border-b border-white/20 pb-2">
                        ...
                        <button className="text-xs uppercase font-bold hover:text-[#C5A880] transition-colors whitespace-nowrap px-2">
                            {t?.join || "Join"}
                        </button>
                    </div>
                </div>
            ...
            <div className="container mx-auto px-8 md:px-20 mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-xs text-gray-600">
                <p>
                    {lang === 'ar' ? (
                        <>
                            © 2026 جميع الحقوق محفوظة. تم التطوير بواسطة <span className="text-[#C5A880] font-bold">Team Elking</span>
                        </>
                    ) : (
                        <>
                            © 2026 All rights reserved. Made by <span className="text-[#C5A880] font-bold">Team Elking</span>
                        </>
                    )}
                </p>
                <p className="hidden md:block opacity-50 hover:opacity-100 transition-opacity cursor-default">
                    Developed by <span className="text-[#C5A880]">HassanElking</span>
                </p>
